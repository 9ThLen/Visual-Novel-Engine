/**
 * The player build's version of `src/lib/bundled-assets.ts`: nothing.
 *
 * A published novel carries its own art. `src/lib/story-backup/capture.ts` resolves
 ...
 * `src/lib/asset-resolver.ts` miss, and their callers fall through to the release's
