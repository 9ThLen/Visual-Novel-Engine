 ...
 *
 * The validators are local rather than shared with `src/lib/story-backup/manifest.ts`.
...
function parsePresentation(value: unknown): ReleasePresentation {
  ...
  // (`src/lib/story-theme.ts`); carrying them through unread would let a malformed
