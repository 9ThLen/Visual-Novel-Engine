 ...
 * `MAJOR.MINOR.PATCH` with no pre-release part (`src/lib/release/version.ts`), so
 ...
 * construction, because `src/lib/release/version.ts` already refuses to republish a
