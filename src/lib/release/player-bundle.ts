 ...
 * next to a fresh Expo build, and `src/lib/release/shell-build.ts`, which does it
 ...
 * `src/lib/story-backup/capture.ts` resolves bundled references and stores their
