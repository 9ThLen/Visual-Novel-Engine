 ...
 * generates a module of them (`src/lib/generated/player-release.ts`) rather than
 ...
 * it is here and not in `src/lib/player-mode.ts` — that file is loaded by Node
...
/**
 * Tell `src/lib/player-mode.ts` where a native build finds its release.
 *
