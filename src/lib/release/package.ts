 ...
 * `src/lib/story-backup/archive.ts` rather than from a second copy. What differs is
 * the manifest inside and the parser that validates it.
 *
 * `src/lib/release/compile.ts` produces everything this needs. In particular it
