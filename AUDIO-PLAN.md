...
**Статус:** реалізовано 2026-08-26 (R4.0–R4.3). Створено 2026-08-26.
...
- **Дедуплікація за назвою.** `addAssetToLibraryPure` зливає активи з однаковою назвою для всього, крім відео ([media-library-service.ts:286](lib/media-library-service.ts:286)). Два різні `track.mp3` з різних тек стануть одним файлом. Для відео цей виняток уже зроблено; для аудіо, яке тепер теж береться з пристрою, його варто повторити — але це зміна семантики сховища, тож окремим релізом.
