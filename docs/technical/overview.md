...
- Old dated reports in `docs/technical/` are historical snapshots and may describe removed code.

## Source Of Truth

- Setup: `README.md`
- Current architecture: `docs/technical/architecture-reference.md`
- Store shape: `docs/technical/stores-reference.md`
- Testing: `docs/technical/testing-guide.md`
- Scene model: `src/lib/engine/types.ts`
- Runtime executor: `src/lib/engine/useSceneExecutor.ts`
- App state: `src/stores/use-app-store.ts`
