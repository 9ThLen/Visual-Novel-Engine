...
### useI18n
- **File:** `src/hooks/use-i18n.ts` (moved from `lib/i18n.ts`)
...
### useTypewriter
- **File:** `src/hooks/useTypewriter.ts` (49 LOC)
...
### useReaderAudio
- **File:** `src/hooks/useReaderAudio.ts` (277 LOC)
...
- **File:** `src/hooks/useReaderInitialization.ts` (144 LOC)
...
### useSceneImages
- **File:** `src/hooks/useSceneImages.ts` (58 LOC)
...
### useAutoSave
- **File:** `src/hooks/useAutoSave.ts` (64 LOC)
...
### useResponsiveLayout
- **File:** `src/hooks/useResponsiveLayout.ts` (43 LOC)
...
- **Implementation:** Uses `useWindowDimensions()` + `getResponsiveValues()` from `src/lib/responsive.ts`

## Utility Hooks

### useColors
- **File:** `src/hooks/use-colors.ts` (13 LOC)
