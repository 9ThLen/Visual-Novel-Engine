...
const env = {
  ...
  appName: "Visual Novel Engine",
  appSlug: "visual-novel-engine",
  appVersion: "1.0.0",
  // S3 URL of the app logo - set this to the URL returned by generate_image when creating custom logo
  // Leave empty to use the default icon from assets/images/icon.png
  logoUrl: "https://d2xsxph8kpxj0f.cloudfront.net/310519663312885251/iBxN3cWrmS9CqKFQkSiKVo/icon-TuqVMeyZr7fGTGgpvVbZpL.webp",
