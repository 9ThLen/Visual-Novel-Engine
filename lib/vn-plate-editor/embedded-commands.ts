...
export const embeddedCommands: EmbeddedCommand[] = [
  ...
  { id: 'character', blockType: 'character', title: 'Character', description: 'Show or change a character' },
  { id: 'sprite', blockType: 'character', title: 'Sprite', description: 'Change character expression or pose' },
