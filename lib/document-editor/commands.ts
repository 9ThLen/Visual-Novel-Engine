...
export const DOCUMENT_COMMANDS: DocumentCommand[] = [
  ...
  },
  {
    ...
    blockType: 'transition',
    title: 'Transition',
    aliases: ['перехід', 'сцена', 'transition', 'scene'],
  ...
  },
  {
    ...
    blockType: 'label',
    title: 'Label',
    aliases: ['мітка', 'якір', 'label', 'anchor'],
    description: 'Mark a jump target inside the scene',
    scope: 'branch',
  },
  {
    id: 'goto',
    blockType: 'goto',
    title: 'Go to',
    aliases: ['перейти', 'стрибок', 'умова', 'goto', 'jump', 'if'],
    description: 'Jump to a label, optionally by condition',
    scope: 'branch',
  },
  {
    id: 'effect',
  ...
  },
  {
    ...
    title: 'Stop effect',
    aliases: ['зупинити ефект', 'стоп ефект', 'stop effect', 'stop', 'clear effect'],
    description: 'Stop active visual effects',
    scope: 'scene',
  },
  {
    id: 'camera',
