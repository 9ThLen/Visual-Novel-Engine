...
function buildRuntimePalette(scheme: ColorScheme): RuntimePalette {
  ...
  const extra = (ThemeColors as any);
  return {
    ...base,
    ...
    border: base.border,
    dialogueBg: extra.dialogueBg?.[scheme],
    nameBg: extra.nameBg?.[scheme],
    nameText: extra.nameText?.[scheme],
    overlay: extra.overlay?.[scheme],
    choiceBg: extra.choiceBg?.[scheme],
    choiceBorder: extra.choiceBorder?.[scheme],
  } as RuntimePalette;
}
